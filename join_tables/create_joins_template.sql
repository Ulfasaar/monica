...
CREATE TABLE ${table_original}_${table}(
	id UUID PRIMARY KEY DEFAULT uuid_generate_v1(),
	${table_original_id_column} UUID REFERENCES ${table_original}(${table_original_id_column}) NOT NULL,
	${table}_id UUID REFERENCES ${table_schema}.${table}(id) NOT NULL
);
...
INSERT INTO ${table_original}_${table}(${table_original_id_column}, ${table}_id)
